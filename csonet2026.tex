...
\begin{document}
%
\title{Application of TCN and Transformer Networks for Large-Scale System Log Anomaly Detection}
\titlerunning{TCN and Transformer for Log Anomaly Detection}
...
\begin{itemize}
    ...
    \item \textbf{RQ3:} Does the performance ranking of these branches remain consistent when moving from synthetic benchmarks to a real-world production environment?
\end{itemize}

The main contributions include: (1) an end-to-end pipeline of Drain3 parsing, event sequencing, and anomaly scoring with five alternative branches (PCA/SVD, Isolation Forest, DeepLog, TCN, and Transformer masked event modeling) evaluated across HDFS, BGL, and a real-world production dataset HUFLIT-Career; (2) a multi-seed evaluation (5 random seeds) on HDFS with a protocol that prevents test set leakage, along with a grouping strategy study for Block ID, fixed window, and sliding window; (3) a cross-dataset evaluation on the same pipeline; (4) an ablation study for Drain3 threshold, DeepLog top-k, and Transformer mask ratio; (5) an inference latency benchmark, expected error analysis, and qualitative explainability case study for deployment-oriented interpretation.
...
\begin{itemize}
    ...
    \item \textbf{Novelty:} We evaluate five scoring branches (from classical to deep models) under a uniform pipeline. Our work is the first to directly compare next-event prediction (LSTM, TCN) with bidirectional masked modeling (Transformer) and frequency baselines (PCA, IF) on a production web log dataset grouped by client IP.
...
\begin{table}[htbp]
\caption{Cross-dataset performance comparison, reported as mean $\pm$ std over 5 seeds.}
\centering
\scriptsize
...
\toprule
& \multicolumn{3}{c}{\textbf{HDFS}} & \multicolumn{3}{c}{\textbf{BGL}} & \multicolumn{3}{c}{\textbf{HUFLIT-Career}} \\
\cmidrule(lr){2-4} \cmidrule(lr){5-7} \cmidrule(lr){8-10}
\textbf{Method} & \textbf{Precision} & \textbf{Recall} & \textbf{F1} & \textbf{Precision} & \textbf{Recall} & \textbf{F1} & \textbf{Precision} & \textbf{Recall} & \textbf{F1} \\
\midrule
PCA & $0.6274 \pm 0.1944$ & $0.5450 \pm 0.0055$ & $0.5711 \pm 0.0944$ & $0.9473 \pm 0.0113$ & $0.8976 \pm 0.0144$ & $0.9217 \pm 0.0098$ & $0.4972 \pm 0.1647$ & $0.8147 \pm 0.0423$ & $0.6065 \pm 0.1426$ \\
TruncatedSVD & $0.4298 \pm 0.2555$ & $0.5527 \pm 0.0106$ & $0.4540 \pm 0.1366$ & $0.9462 \pm 0.0051$ & $0.9255 \pm 0.0228$ & $0.9356 \pm 0.0117$ & $0.1875 \pm 0.4193$ & $0.0400 \pm 0.0894$ & $0.0659 \pm 0.1474$ \\
Isolation Forest & $0.1726 \pm 0.0146$ & $0.1080 \pm 0.0084$ & $0.1328 \pm 0.0103$ & $0.1110 \pm 0.0171$ & $0.0248 \pm 0.0045$ & $0.0404 \pm 0.0070$ & $\mathbf{0.5144 \pm 0.0168}$ & $0.8107 \pm 0.0456$ & $\mathbf{0.6292 \pm 0.0235}$ \\
\midrule
Transformer (unsup.) & $0.2094 \pm 0.0490$ & $0.2982 \pm 0.0892$ & $0.2458 \pm 0.0639$ & $0.9422 \pm 0.0110$ & $0.9073 \pm 0.0216$ & $0.9242 \pm 0.0085$ & N/A & N/A & N/A \\
Transformer (val-tuned) & $0.5102 \pm 0.1497$ & $0.2365 \pm 0.1156$ & $0.2950 \pm 0.0693$ & $\mathbf{0.9841 \pm 0.0017}$ & $0.8975 \pm 0.0157$ & $0.9388 \pm 0.0080$ & $0.2323 \pm 0.0163$ & $0.7280 \pm 0.0983$ & $0.3520 \pm 0.0304$ \\
DeepLog (top-k) & $0.9862 \pm 0.0201$ & $0.3013 \pm 0.0167$ & $0.4613 \pm 0.0199$ & $0.9654 \pm 0.0083$ & $\mathbf{0.9991 \pm 0.0012}$ & $0.9820 \pm 0.0042$ & $0.4533 \pm 0.2542$ & $0.0360 \pm 0.0219$ & $0.0665 \pm 0.0401$ \\
DeepLog (NLL) & $0.2644 \pm 0.0198$ & $0.3601 \pm 0.0256$ & $0.3046 \pm 0.0198$ & $0.9408 \pm 0.0066$ & $0.9355 \pm 0.0157$ & $0.9381 \pm 0.0075$ & $0.4642 \pm 0.0062$ & $\mathbf{0.8160 \pm 0.0270}$ & $0.5916 \pm 0.0096$ \\
\midrule
\textbf{TCN (top-k)} & $0.9862 \pm 0.0201$ & $0.3013 \pm 0.0167$ & $0.4613 \pm 0.0199$ & $0.9666 \pm 0.0039$ & $\mathbf{0.9991 \pm 0.0012}$ & $0.9826 \pm 0.0022$ & $0.4081 \pm 0.1306$ & $0.0240 \pm 0.0089$ & $0.0451 \pm 0.0167$ \\
\textbf{TCN (NLL)} & $0.2621 \pm 0.0277$ & $0.3644 \pm 0.0291$ & $0.3042 \pm 0.0236$ & $0.9412 \pm 0.0085$ & $0.9537 \pm 0.0094$ & $0.9474 \pm 0.0035$ & $0.4642 \pm 0.0062$ & $\mathbf{0.8160 \pm 0.0270}$ & $0.5916 \pm 0.0096$ \\
\bottomrule
\end{tabular}%
}
...
On the real-world production dataset, HUFLIT-Career, traditional machine learning models outperform the deep sequence models. Isolation Forest achieves the highest overall F1-score of $0.6292 \pm 0.0235$, followed closely by PCA at $0.6065 \pm 0.1426$. Among the sequence-based models, DeepLog (NLL) and TCN (NLL) both obtain a competitive F1-score of $0.5916 \pm 0.0096$. However, the top-k mismatch mode for both DeepLog and TCN performs poorly on this dataset, yielding F1-scores of $0.0665 \pm 0.0401$ and $0.0451 \pm 0.0167$, respectively. This performance divergence reveals a critical architectural insight: because the HUFLIT-Career dataset has a highly compact vocabulary of only 6 event templates after Drain3 parsing, event transitions remain regular and predictable, rendering top-k next-event prediction mismatches ineffective. In contrast, NLL thresholding allows TCN and DeepLog to capture subtle shifts in transition likelihoods, yielding a robust F1-score of 0.5916. The high performance of Isolation Forest and PCA further indicates that anomalies on simple-vocabulary web logs are characterized more by frequency distributions than by sequential pattern deviations. This cross-dataset divergence — where lightweight baselines prevail on HDFS, sequence models excel on BGL, and frequency/likelihood scoring dominates on HUFLIT-Career — highlights that the choice of scoring branch should be guided by dataset characteristics and vocabulary complexity rather than model capacity alone.
...
To enhance operational utility, we present a qualitative explainability layer based on next-event prediction mismatches. Table~\ref{tab_explainability} illustrates two concrete anomaly cases extracted from HDFS and BGL test sets using TCN. When a sequence is flagged, the system outputs the failed event position, the actual versus top-3 predicted event templates, and a severity score (NLL). For instance, in BGL sequence \texttt{W20200}, the unexpected occurrence of \texttt{E18} (data TLB error interrupt) instead of the highly probable normal transitions (\texttt{E3}, \texttt{E6}, \texttt{E4}) produces a high anomaly score ($12.68$), immediately guiding operators to a virtual memory subsystem fault.
